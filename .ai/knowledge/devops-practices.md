...
- Cross-reference with tech stack decisions (see `tech-stack-reference.md`)
...
- Cross-reference: `tech-stack-reference.md` — project tech stack (Docker, K8s, GitLab CI)
- Cross-reference: `software-architecture-patterns.md` — architecture decisions that affect deployment
