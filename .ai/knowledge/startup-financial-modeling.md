...
- Cross-reference with startup resources: see `startup-resources-ru.md`
...
- **Test pricing before scaling:** pricing is a hypothesis, not a decision. Validate willingness to pay in customer discovery (see `jtbd-custdev.md`)
...
- Cross-reference: `startup-resources-ru.md` — Russian startup ecosystem resources
- Cross-reference: `jtbd-custdev.md` — customer discovery and willingness-to-pay validation
- Cross-reference: `sales-methodologies.md` — pipeline metrics and deal velocity
- Cross-reference: `strategy-frameworks.md` — Lean Canvas, Business Model Canvas
