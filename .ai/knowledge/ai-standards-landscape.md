...
| Safety | GUARDS.md invariants; red lines in Manifesto |
...
- Run SAST/SCA on all AI-generated code (see `devops-practices.md`)
...
- Cross-reference: `devops-practices.md` — DevSecOps and AI-generated code security
- Cross-reference: `.ai/ONTOLOGY.md` — vAIbe-OS ontological foundation (self-governance)
- Cross-reference: `.ai/MANIFESTO.md` — behavioral principles (transparency, honesty about LLM limitations)
