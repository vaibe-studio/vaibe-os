...
- Planning infrastructure and deployment strategies (see `devops-practices.md`)
- Making build-vs-buy decisions (see `strategy-frameworks.md` — Wardley Maps)
...
- OpenGitOps. `https://opengitops.dev/` (see also `devops-practices.md`)
- Cross-reference: `tech-stack-reference.md` — project tech stack
- Cross-reference: `devops-practices.md` — CI/CD, deployment strategies, container orchestration
- Cross-reference: `strategy-frameworks.md` — Wardley Maps for build/buy/outsource decisions
