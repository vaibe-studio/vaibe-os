---
name: figjam-diagram
description: Generate visual project artifacts as FigJam diagrams via Figma MCP
triggers:
  - figjam
  - diagram
  - диаграмма
...
- `software-architecture-patterns.md` — architecture diagrams (DDD context maps, microservices topology, event-driven flows)
- `strategy-frameworks.md` — Wardley Maps, Business Model Canvas, Value Proposition Canvas for strategic diagrams
- `devops-practices.md` — CI/CD pipeline diagrams, infrastructure topology
- `agile-frameworks.md` — Scrum/Kanban board layouts, sprint flow visualizations
