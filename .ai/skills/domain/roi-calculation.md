...
description: Build ROI business case for B2B sales with cost saving and revenue uplift
triggers: [ROI, business case, cost saving, revenue uplift, payback, CFO]
origin: bundled
---
...
- `startup-financial-modeling.md` — unit economics (CAC, LTV, payback), P&L structure, pricing strategies
- `strategy-frameworks.md` — Business Model Canvas for mapping value creation and cost structure
- `sales-methodologies.md` — MEDDPICC Metrics element for grounding ROI in buyer's numbers
