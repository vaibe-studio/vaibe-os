...
description: Formulate, score, and test product hypotheses using HADI methodology
triggers: [hypothesis, гипотеза, HADI, validate, проверка гипотезы, product hypothesis]
origin: bundled
---
...
- `jtbd-custdev.md` — JTBD theory, Customer Development, HADI cycles, hypothesis formulation, interview techniques, pivot criteria
- `strategy-frameworks.md` — Lean Canvas, Value Proposition Canvas for framing hypotheses in business model context
- `startup-financial-modeling.md` — unit economics benchmarks for validating financial hypotheses
