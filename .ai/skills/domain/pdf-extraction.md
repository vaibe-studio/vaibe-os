---
name: pdf-extraction
description: Extract text from PDF files and convert to structured Markdown
triggers: [PDF, extract, OCR, markdown, convert PDF, pdf2md]
origin: bundled
---
...
- `tech-stack-reference.md` — Python tools and libraries for extraction
- `glossary.md` — term disambiguation for domain-specific content in extracted documents
