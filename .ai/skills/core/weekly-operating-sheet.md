...
description: Create a cross-project weekly operating sheet for managerial work with decisions, owners, waiting list, and daily log
triggers: [weekly operating sheet, operating week, управленческая неделя, недельная таблица, owner map, weekly sheet, секретарь на неделю, менеджерская неделя]
---
...
- Single-project sprint planning → use `plan-update.md`
- Weekly retrospective / summary → use `weekly-review.md`
- Task execution for one task card → use `task-execute.md`
