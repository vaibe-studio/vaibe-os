...
description: Interactively process and import files from Inbox into vAIbe-OS directory structure
triggers: [inbox, import, inbox-check, разобрать инбокс]
---
...
- `.ai/rules/structure.md` — naming and structure rules
...
- Recommend placement: general KB only / project KB only / both
...
- For PDFs: extract text using `tools/pdf_to_markdown/`
