...
| Kanban board | External issue-tracker integration (sync plans ↔ tracker) |
...
- PMBoK 7 principles reference: see `.vaibe/skills/pmbok7-principles/SKILL.md` in this knowledge base
