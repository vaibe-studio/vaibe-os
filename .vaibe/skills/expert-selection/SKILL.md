...
description: Select and prioritize experts for consultations based on scoring criteria. Triggers: expert, consultation, mentor, advisor, competence, scoring.
license: MIT
---
...
- `.vaibe/skills/jtbd-custdev/SKILL.md` — interview techniques for structuring expert consultation questions
- `.vaibe/skills/pmbok7-principles/SKILL.md` — Stakeholder engagement principles for expert relationship management
- `.vaibe/skills/strategy-frameworks/SKILL.md` — frameworks to focus expert consultation scope (Porter, Wardley Maps)
