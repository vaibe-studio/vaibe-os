...
Usage:
    uv run --project .vaibe/skills/meeting-processing/scripts/video_transcribe .vaibe/skills/meeting-processing/scripts/video_transcribe/main.py
    uv run --project .vaibe/skills/meeting-processing/scripts/video_transcribe .vaibe/skills/meeting-processing/scripts/video_transcribe/main.py --input video.mp4
    uv run --project .vaibe/skills/meeting-processing/scripts/video_transcribe .vaibe/skills/meeting-processing/scripts/video_transcribe/main.py --language ru
"""
