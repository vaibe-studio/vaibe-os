...
description: Map and prioritize all stakeholders using influence/interest matrix. Triggers: stakeholder, стейкхолдер, stakeholder map, карта стейкхолдеров, заинтересованные стороны.
license: MIT
---
...
- `.vaibe/skills/pmbok7-principles/SKILL.md` — Stakeholders performance domain, engagement assessment matrices
- `.vaibe/skills/strategy-frameworks/SKILL.md` — Value Proposition Canvas for mapping stakeholder needs
- `.vaibe/skills/sales-methodologies/SKILL.md` — MEDDPICC Champion/Economic Buyer identification for sales stakeholders
