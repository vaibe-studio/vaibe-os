...
description: Conduct market research with defensible TAM/SAM/SOM and competitive analysis. Triggers: market research, TAM, SAM, SOM, competitors, market size, landscape.
license: MIT
---
...
- `.vaibe/skills/strategy-frameworks/SKILL.md` — Porter's Five Forces for industry analysis, SWOT for positioning, Blue Ocean for differentiation
- `.vaibe/skills/jtbd-custdev/SKILL.md` — Jobs-to-be-Done for understanding customer needs behind market demand
- `.vaibe/skills/startup-financial-modeling/SKILL.md` — TAM/SAM/SOM validation with unit economics and pricing models
- `.vaibe/skills/market-research/references/startup-resources-ru.md` — Russian market research sources, venture analytics, HSE data
